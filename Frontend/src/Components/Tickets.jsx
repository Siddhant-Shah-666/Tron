  ...
  return (
    <>
      {tickets && tickets?.map((ticket) => (
        <div key={ticket?._id} className={` ${!mytask?"hidden":""}  w-[90vw] md:h-[30vh] md:w-[25vw]   rounded-xl font-bold flex flex-col justify-center items-start p-3 md:py-20 md:px-8 gap-1 md:gap-2 m-2  border bg-slate-950/40 backdrop-blur-md  border-cyan-400 text-cyan-300 
