  ...
  return (
    <>
      ...
      shadow-lg shadow-cyan-400/30 `}>
        ...
        <Link to={`/viewtickets/${ticket?._id}`}><button className='h-[4vh] w-[80vw] md:w-[20vw]  rounded-xl text-white rounded hover:bg-cyan-500 border bg-cyan-800  border-cyan-400 shadow-lg shadow-cyan-400/30'>View</button></Link>
        </div>
      ))}
    </>
  );
